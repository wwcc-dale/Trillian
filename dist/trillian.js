...
`),b.hasAttribute("data-start")||b.setAttribute("data-start",String(w+1))}k.textContent=f,x.highlightElement(k)},function(f){b.setAttribute(r,y),k.textContent=f})}}),x.plugins.fileHighlight={highlight:function(b){for(var k=(b||document).querySelectorAll(c),o=0,l;l=k[o++];)x.highlightElement(l)}};var p=!1;x.fileHighlight=function(){p||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),p=!0),x.plugins.fileHighlight.highlight.apply(this,arguments)}})()});function H(e,t){return/^#[0-9a-f]{6}$/i.test(e)?e+Math.round(t*255).toString(16).padStart(2,"0"):e}function Q(e){return 1-Math.pow(1-e,3)}function ee(e){return Array.from(e.childNodes).filter(t=>!(t.nodeType===1&&t.tagName==="UL")).map(t=>t.textContent).join("").trim()}function te(e){let t=e.querySelector(":scope > ul");return t?Array.from(t.querySelectorAll(":scope > li")).map(n=>n.innerHTML):[]}function It(e,t=".trillian"){let n=0,a=!1,r=-1;return e.replace(/([^{}]*)([\{\}])/g,(i,u,y)=>{if(y==="}")return a&&n===r&&(a=!1,r=-1),n--,u+"}";n++;let c=u.trim();return c?/^@keyframes\s/i.test(c)?(a=!0,r=n,u+"{"):a||c.startsWith("@")?u+"{":c.split(",").map(s=>`${t} ${s.trim()}`).join(", ")+" {":u+"{"})}function C(e,t){if(document.getElementById(e))return;let n=document.createElement("style");n.id=e,n.textContent=It(t),document.head.appendChild(n)}function M(e,t,n=.1){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){t(!0);return}if(!("IntersectionObserver"in window)){t(!1);return}let r=new IntersectionObserver(i=>{i[0].isIntersecting&&(t(!1),r.disconnect())},{threshold:n});r.observe(e)}function F(e,t,n){new MutationObserver(a=>{for(let r of a)for(let i of r.addedNodes){if(i.nodeType!==1)continue;(i.matches(e)?[i]:Array.from(i.querySelectorAll(e))).filter(t).forEach(n)}}).observe(document.documentElement,{childList:!0,subtree:!0})}var Ee={info:{bg:"#eff6ff",border:"#3b82f6",text:"#1e3a5f",icon:"#3b82f6",label:"Info"},warning:{bg:"#fffbeb",border:"#f59e0b",text:"#78350f",icon:"#f59e0b",label:"Warning"},success:{bg:"#f0fdf4",border:"#22c55e",text:"#14532d",icon:"#22c55e",label:"Success"},error:{bg:"#fef2f2",border:"#ef4444",text:"#7f1d1d",icon:"#ef4444",label:"Error"},tip:{bg:"#faf5ff",border:"#a855f7",text:"#4a1772",icon:"#a855f7",label:"Tip"}},Rt={info:'<svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="8.5" stroke="currentColor" stroke-width="1.6"/><line x1="10" y1="9" x2="10" y2="14" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><circle cx="10" cy="6.5" r="1.1" fill="currentColor"/></svg>',warning:'<svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M10 3.5L17.5 16.5H2.5L10 3.5Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><line x1="10" y1="8.5" x2="10" y2="12.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><circle cx="10" cy="14.5" r="1.1" fill="currentColor"/></svg>',success:'<svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="8.5" stroke="currentColor" stroke-width="1.6"/><path d="M6.5 10l2.5 2.5 4.5-4.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',error:'<svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="8.5" stroke="currentColor" stroke-width="1.6"/><path d="M7 7l6 6M13 7l-6 6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',tip:'<svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M10 2a5.5 5.5 0 0 1 2.75 10.25V14a.75.75 0 0 1-.75.75h-4a.75.75 0 0 1-.75-.75v-1.75A5.5 5.5 0 0 1 10 2z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M8 17.5h4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>'};function Pt(){C("trl-alert-styles",`
  ...
  `)}function Fe(e){let t=e.querySelector("p");return t&&/^alert\s*:/i.test(t.textContent.trim())}function Dt(e){let t=Array.from(e.querySelectorAll("p"));if(!t.length)return null;let n=/^alert\s*:\s*(\w+)/i.exec(t[0].textContent.trim());if(!n)return null;let a=n[1].toLowerCase(),r=Ee[a]?a:"info",i;if(t.length>1)i=t.slice(1).map(u=>`<p>${u.innerHTML}</p>`).join("");else{let u=t[0].innerHTML,y=u.search(/<br\s*\/?>/i),c=y>-1?u.slice(y).replace(/^<br\s*\/?>/i,"").trim():"";i=c?`<p>${c}</p>`:""}return{type:r,bodyHtml:i}}function Ce(e){Pt();let t=Dt(e);if(!t)return;let{type:n,bodyHtml:a}=t,r=Ee[n],i=document.createElement("div");i.className="trl-alert-callout",i.setAttribute("role","note"),i.setAttribute("aria-label",r.label),i.style.setProperty("--trl-alert-bg",r.bg),i.style.setProperty("--trl-alert-border",r.border),i.style.setProperty("--trl-alert-text",r.text),i.style.setProperty("--trl-alert-icon",r.icon),i.innerHTML=`
    <span class="trl-alert-icon-wrap">${Rt[n]}</span>
    <div class="trl-alert-body">${a}</div>
  `,e.replaceWith(i),M(i,()=>i.classList.add("trl-alert-in"))}function Ae(){document.querySelectorAll("blockquote").forEach(e=>{Fe(e)&&Ce(e)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ae):Ae();F("blockquote",Fe,Ce);var $e={accent:"#4a90d9",info:"#3b82f6",warning:"#f59e0b",success:"#22c55e",error:"#ef4444",tip:"#a855f7",cert:"#7b68ee",degree:"#e8a838",neutral:"#888888"};function zt(){C("trl-pill-styles",`
    .trl-pill {
      display: inline-flex;
      align-items: center;
      padding: 1px 4px;
  ...
  `)}function Le(e){return/^#pill(:|$)/i.test(e.getAttribute("href")||"")}function _e(e){zt();let t=e.getAttribute("href")||"",n=/^#pill(?::(.+))?$/i.exec(t);if(!n)return;let a=(n[1]||"accent").toLowerCase(),r=$e[a]||$e.accent,i=document.createElement("span");i.className="trl-pill",i.textContent=e.textContent,i.style.setProperty("--trl-pill-bg",r),e.replaceWith(i)}function Me(){document.querySelectorAll("a").forEach(e=>{Le(e)&&_e(e)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Me):Me();F("a",Le,_e);var Te="checklist";function jt(e,t){let n=e+"\0"+t.join(""),a=0;for(let i=0;i<n.length;i++)a=Math.imul(a,31)+n.charCodeAt(i)|0;return`trillian-cl-${location.pathname.replace(/[^a-z0-9]/gi,"-").replace(/-+/g,"-").slice(0,40)}-${(a>>>0).toString(36)}`}function Ht(e){try{return new Set(JSON.parse(localStorage.getItem(e))||[])}catch(t){return new Set}}function Bt(e,t){try{localStorage.setItem(e,JSON.stringify([...t]))}catch(n){}}function Oe(e){let t=e.querySelector("li:first-child");if(!t)return!1;let n=t.textContent.trim().toLowerCase();return n===Te||n.startsWith(Te+":")}function qt(e){let t=e.querySelector("li:first-child").textContent.trim(),n=t.indexOf(":"),a=n>-1?t.slice(n+1).trim():"",r=Array.from(e.querySelectorAll(":scope > li")).slice(1).map(i=>i.textContent.trim()).filter(Boolean);return{title:a,items:r}}function Ut(){C("trl-check-styles",`
    .trl-check-widget {
      font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
      background: #fff;
      border-radius: 16px;
  ...
  `)}function Gt(e,t,n){let a=t?(n/t*100).toFixed(1):0,r=e.querySelector(".trl-check-bar-fill"),i=e.querySelector(".trl-check-bar"),u=e.querySelector(".trl-check-count");r&&(r.style.width=`${a}%`),i&&i.setAttribute("aria-valuenow",Math.round(a)),u&&(u.textContent=`${n} / ${t}`)}function Wt(e){let{title:t,items:n}=qt(e),a=jt(t,n),r=Ht(a),i=a.slice(-8),u=document.createElement("div");u.className="trl-check-widget",u.style.setProperty("--trl-check-accent","#4a90d9");let y=n.filter((d,s)=>r.has(s)).length,c=n.length?(y/n.length*100).toFixed(1):0;return u.innerHTML=`
  ...
  `)}function Xt(e){return/^javascript:/i.test(e.trim())?"#":e.trim()}function Yt(e){let t=e.includes("\xB7")?"\xB7":" | ",n=e.split(t).map(c=>c.trim()).filter(Boolean);if(n.length<2)return null;let[a,r,i="primary",u="",y="left"]=n;return!a||!r?null:{label:a,href:Xt(r),style:i.toLowerCase(),iconName:u.toLowerCase(),iconPos:y.toLowerCase()==="right"?"right":"left"}}function je(e){let t=e.querySelector("li:first-child");if(!t)return!1;let n=t.textContent.trim().toLowerCase();return n===Pe||n.startsWith(Pe+":")}function Jt(e){let t=e.querySelector("li:first-child").textContent.trim(),n=t.indexOf(":"),a=n>-1?t.slice(n+1).trim().toLowerCase():"left",r=["center","right"].includes(a)?a:"left",i=Array.from(e.querySelectorAll(":scope > li")).slice(1).map(u=>Yt(u.textContent.trim())).filter(Boolean);return{align:r,items:i}}var Qt={left:"flex-start",center:"center",right:"flex-end"},De="#4a90d9";function He(e){Kt();let{align:t,items:n}=Jt(e);if(!n.length)return;let a=document.createElement("div");a.className="trl-btn-row",a.style.justifyContent=Qt[t]||"flex-start",a.style.setProperty("--trl-btn-accent",De),a.style.setProperty("--trl-btn-accent-10",H(De,.1)),n.forEach(({label:r,href:i,style:u,iconName:y,iconPos:c})=>{let d=document.createElement("a");d.className=`trl-btn-btn trl-btn-${Zt.includes(u)?u:"primary"}`,d.href=i;let s=Re(y);if(s){let p=document.createElement("span");p.className="trl-btn-icon",p.innerHTML=s,c==="right"?(d.appendChild(document.createTextNode(r)),d.appendChild(p)):(d.appendChild(p),d.appendChild(document.createTextNode(r)))}else d.textContent=r;a.appendChild(d)}),e.replaceWith(a),M(a,()=>a.classList.add("trl-btn-in"))}function ze(){document.querySelectorAll("ul").forEach(e=>{je(e)&&He(e)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ze):ze();F("ul",je,He);var Be="accordion",er='<svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M4 6l4 4 4-4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>';function tr(){C("trl-acc-styles",`
    .trl-acc-widget {
      font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
      background: #fff;
      border-radius: 16px;
  ...
  `)}function rr(e,t){if(t){e.style.height="auto";return}e.style.height=e.scrollHeight+"px",e.addEventListener("transitionend",()=>{e.style.height!=="0px"&&(e.style.height="auto")},{once:!0})}function nr(e,t){if(t){e.style.height="0";return}e.style.height=e.scrollHeight+"px",requestAnimationFrame(()=>requestAnimationFrame(()=>{e.style.height="0"}))}function Ue(e){let t=e.querySelector("li:first-child");if(!t)return!1;let n=t.textContent.trim().toLowerCase();return n===Be||n.startsWith(Be+":")}function ar(e){let t=e.querySelector("li:first-child").textContent.trim(),n=t.indexOf(":"),a=n>-1?t.slice(n+1).trim():"",r=Array.from(e.querySelectorAll(":scope > li")).slice(1).map(i=>({heading:ee(i),paras:te(i)})).filter(i=>i.heading);return{label:a,items:r}}function Ge(e){tr();let{label:t,items:n}=ar(e);if(!n.length)return;let a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=document.createElement("div");if(r.className="trl-acc-widget",r.style.setProperty("--trl-acc-accent","#4a90d9"),t){let i=document.createElement("p");i.className="trl-acc-label",i.textContent=t,r.appendChild(i)}n.forEach((i,u)=>{let y=`trl-acc-panel-${u}-${Math.random().toString(36).slice(2,7)}`,c=`trl-acc-btn-${u}-${Math.random().toString(36).slice(2,7)}`,d=document.createElement("div");d.className="trl-acc-item";let s=document.createElement("button");s.className="trl-acc-trigger",s.id=c,s.setAttribute("aria-expanded","false"),s.setAttribute("aria-controls",y),s.innerHTML=`<span>${i.heading}</span><span class="trl-acc-chevron">${er}</span>`;let p=document.createElement("div");p.className="trl-acc-panel",p.id=y,p.setAttribute("role","region"),p.setAttribute("aria-labelledby",c),p.style.height="0";let m=document.createElement("div");m.className="trl-acc-panel-inner",m.innerHTML=i.paras.length?i.paras.map(b=>`<p>${b}</p>`).join(""):"<p></p>",p.appendChild(m),s.addEventListener("click",()=>{let b=s.getAttribute("aria-expanded")==="true";s.setAttribute("aria-expanded",String(!b)),b?nr(p,a):rr(p,a)}),d.appendChild(s),d.appendChild(p),r.appendChild(d)}),e.replaceWith(r),M(r,()=>r.classList.add("trl-acc-in"))}function qe(){document.querySelectorAll("ul").forEach(e=>{Ue(e)&&Ge(e)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",qe):qe();F("ul",Ue,Ge);var ir="tabs";function or(){C("trl-tabs-styles",`
    .trl-tabs-widget {
      font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
      background: #fff;
      border-radius: 16px;
  ...
  `)}function dr(e){let t=e.match(/^([^0-9]*)([0-9][0-9,.]*)([^0-9]*)$/);if(!t)return null;let n=parseFloat(t[2].replace(/,/g,""));return isNaN(n)?null:{prefix:t[1],num:n,suffix:t[3]}}function ur(e,t,n){let a=Math.max(600,Math.min(1400,t.num*20));setTimeout(()=>{let r=performance.now(),i=u=>{let y=Math.min((u-r)/a,1);e.textContent=t.prefix+Math.round(Q(y)*t.num)+t.suffix,y<1&&requestAnimationFrame(i)};requestAnimationFrame(i)},n)}function Ye(e){let t=e.querySelector("li:first-child");if(!t)return!1;let n=t.textContent.trim().toLowerCase();return n===Ke||n.startsWith(Ke+":")}function pr(e){let t=e.includes("\xB7")?"\xB7":" | ",n=e.split(t).map(u=>u.trim()).filter(Boolean);if(n.length<2)return null;let[a,r,i]=n;return{value:a,label:r,color:lr(i)}}function gr(e){return Array.from(e.querySelectorAll(":scope > li")).slice(1).map(t=>pr(t.textContent.trim())).filter(Boolean)}function Je(e){cr();let t=gr(e);if(!t.length)return;let n=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=document.createElement("div");a.className="trl-stat-row";let r=[];t.forEach((i,u)=>{let y=document.createElement("div");y.className="trl-stat-card",y.style.setProperty("--trl-stat-color",i.color);let c=document.createElement("div");c.className="trl-stat-value";let d=document.createElement("div");d.className="trl-stat-label",d.textContent=i.label;let s=dr(i.value);s&&!n?(c.textContent=s.prefix+"0"+s.suffix,r.push({el:c,parsed:s,delay:u*120})):c.textContent=i.value,y.appendChild(c),y.appendChild(d),a.appendChild(y)}),e.replaceWith(a),M(a,i=>{i||r.forEach(({el:u,parsed:y,delay:c})=>ur(u,y,c)),a.classList.add("trl-stat-in")},.25)}function Xe(){document.querySelectorAll("ul").forEach(e=>{Ye(e)&&Je(e)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Xe):Xe();F("ul",Ye,Je);var I=168,pe=Math.round(I*.12),ge=(I-pe)/2,de=I/2,ue=I/2,V=2*Math.PI*ge,fe=V*(300/360),fr=V-fe,hr=120,mr={session:0,module:0,"course-order":1,"course-name":"","course-code":"","total-sessions":25,"credits-per-course":5,"credits-per-session":.2,"milestone-mini":20,"milestone-cert":45,"milestone-degree":90,"program-short-name":"","program-short-title":"Short Certificate","program-cert-name":"","program-cert-title":"Certificate","program-degree-name":"","program-degree-title":"AAS Degree","accent-color":"#4a90d9","cert-color":"#7b68ee","degree-color":"#e8a838","bg-color":"#ffffff","track-color":"#e8e4df",layout:"row"};function tt(){C("trl-dash-styles",`
    .trl-dash-widget {
      display: block;
      font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
    }
  ...
  `)}var br="progress-dashboard";function rt(e){let t=e.querySelector("li:first-child");return t&&t.textContent.trim().toLowerCase()===br}function yr(e){let t=Object.assign({},mr);return Array.from(e.querySelectorAll("li")).slice(1).forEach(n=>{let a=n.textContent.trim(),r=a.indexOf(":");if(r>0){let i=a.slice(0,r).trim(),u=a.slice(r+1).trim();i&&u!==""&&(t[i]=u)}}),t}function xr(e){let t=parseFloat(e.session)||0,n=parseFloat(e.module)||0,a=Math.max(1,parseFloat(e["course-order"])||1),r=parseFloat(e["total-sessions"])||25,i=parseFloat(e["credits-per-course"])||5,u=parseFloat(e["credits-per-session"])||.2,y=parseFloat(e["milestone-mini"])||0,c=parseFloat(e["milestone-cert"])||0,d=parseFloat(e["milestone-degree"])||0,s=(a-1)*i+t*u,p=fe*Math.min(t/r,1),m=Math.floor(n),b=y?Math.min(100,s/y*100):0,k=c?Math.min(100,s/c*100):0,o=d?Math.min(100,s/d*100):0,l="";if(t>0){let g=Math.floor(t),h=Math.round(t%1*10),f=h>0?` <span class="trl-dash-part">(Part ${h})</span>`:"";l=`Session ${g}${f}, of ${r}`}return{session:t,creditNum:m,progressLen:p,sessionLabel:l,miniPct:b,certPct:k,degreePct:o}}function vr(e){let t=xr(e),n=e["accent-color"],a=e["cert-color"],r=e["degree-color"],i=e.layout,u=e["course-name"],y=e["course-code"],c=e["program-short-name"],d=e["program-short-title"],s=e["program-cert-name"],p=e["program-cert-title"],m=e["program-degree-name"],b=e["program-degree-title"],k=(l,g,h,f)=>l?`
    ...
    <div class="trl-dash-card" role="region" aria-label="Student Progress Dashboard">
      ...
      <div class="trl-dash-body${i==="column"?" trl-dash-col":""}">
    ...
    </div>`,{wrap:o,data:t}}function Qe(e,t){let n=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=e.querySelector(".trl-dash-card"),r=e.querySelector(".trl-dash-arc"),i=e.querySelector(".trl-dash-credit-num"),u=e.querySelectorAll(".trl-dash-bar-fill"),y=(V-t.progressLen).toFixed(2);if(requestAnimationFrame(()=>a&&a.classList.add("trl-dash-visible")),n){r&&(r.style.strokeDashoffset=y),i&&(i.textContent=t.creditNum),u.forEach(c=>{c.style.width=`${c.dataset.pct}%`});return}if(r&&setTimeout(()=>{r.style.strokeDashoffset=y,setTimeout(()=>r.classList.add("trl-dash-glow"),1350)},250),i){let c=t.creditNum;if(c>0){let d=Math.max(500,Math.min(1200,c*150)),s=performance.now(),p=m=>{let b=Math.min((m-s)/d,1);i.textContent=Math.round(Q(b)*c),b<1&&requestAnimationFrame(p)};setTimeout(()=>requestAnimationFrame(p),250)}else i.textContent=0}u.forEach((c,d)=>{setTimeout(()=>{c.style.width=`${c.dataset.pct}%`},400+d*180)})}function nt(e){let t=yr(e),{wrap:n,data:a}=vr(t);if(e.replaceWith(n),"IntersectionObserver"in window){let r=new IntersectionObserver(i=>{i[0].isIntersecting&&(Qe(n,a),r.disconnect())},{threshold:.25});r.observe(n)}else Qe(n,a)}function et(){tt(),document.querySelectorAll("ul").forEach(e=>{rt(e)&&nt(e)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",et):et();F("ul",rt,e=>{tt(),nt(e)});var at="trl-lb-styles";function wr(){if(document.getElementById(at))return;let e=document.createElement("style");e.id=at,e.textContent=`
    .trl-lb-trigger {
      cursor: zoom-in;
    }
    .trl-lb-overlay {
  ...
  `)}var Ir={javascript:"JS",js:"JS",jsx:"JSX",typescript:"TS",ts:"TS",css:"CSS",markup:"HTML",html:"HTML",xml:"XML",python:"Python",py:"Python",bash:"Bash",shell:"Bash",sh:"Bash",json:"JSON",markdown:"Markdown",md:"Markdown"};function ft(e){return!!ht(e)&&!e.dataset.trlCode}function ht(e){for(let t of e.classList){let n=t.match(/^language-(.+)$/);if(n)return n[1].toLowerCase()}return null}function mt(e){Or(),e.dataset.trlCode="1";let t=ht(e),n=Ir[t]||t,a=e.parentElement;if(a&&a.tagName==="PRE"){let y=document.createElement("span");y.className="trl-code-label",y.textContent=n,a.insertBefore(y,e),a.classList.contains(`language-${t}`)||a.classList.add(`language-${t}`)}let i={js:"javascript",ts:"typescript",py:"python",html:"markup",sh:"bash",shell:"bash",md:"markdown"}[t]||t,u=be.default.languages[i];u&&(e.innerHTML=be.default.highlight(e.textContent,u,i))}function gt(){document.querySelectorAll('pre > code[class*="language-"]').forEach(e=>{ft(e)&&mt(e)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",gt):gt();F("code",ft,mt);var ie=window.ENV,bt=ie&&ie.COURSE_ID,yt=ie&&ie.current_user_id;if(bt&&yt){let e=/^\/courses\/\d+\/(pages|assignments|quizzes|discussion_topics|modules\/items)\//,t=window.location.pathname;if(e.test(t)){let n="trl-pace-log-"+bt+"-"+yt;try{let a=JSON.parse(localStorage.getItem(n)||"[]");Array.isArray(a)||(a=[]),a.some(function(r){return r.url===t})||(a.push({url:t,t:Date.now()}),localStorage.setItem(n,JSON.stringify(a)))}catch(a){}}}var Rr="pace-dashboard",ve=[{lo:0,color:"#ef4444",label:"Way Behind"},{lo:.4,color:"#f59e0b",label:"Behind"},{lo:.8,color:"#22c55e",label:"On Track"},{lo:1.2,color:"#3b82f6",label:"Ahead"},{lo:1.6,color:"#a855f7",label:"Way Ahead"}];function wt(e){let t=ve[0];for(let n of ve)e>=n.lo&&(t=n);return t}var Pr="http://www.w3.org/2000/svg",Z=88,oe=20,q=130,U=130,kt=2*Math.PI*Z,Dr=kt/2,ye=Dr/5;function B(e,t){let n=document.createElementNS(Pr,e);for(let[a,r]of Object.entries(t))n.setAttribute(a,String(r));return n}function zr(e){let t=(180-Math.min(2,Math.max(0,e))*90)*Math.PI/180,n=Z-oe/2-4;return[q+n*Math.cos(t),U-n*Math.sin(t)]}function jr(e){let t=wt(e),n=B("svg",{viewBox:"0 0 260 138","aria-hidden":"true",style:"width:100%"}),a=B("g",{transform:"rotate(180 "+q+" "+U+")"});ve.forEach((y,c)=>{let d=(c*ye).toFixed(2),s=(kt-(c+1)*ye).toFixed(2);a.appendChild(B("circle",{cx:q,cy:U,r:Z,fill:"none",stroke:y.color,"stroke-width":oe,"stroke-dasharray":d+" "+ye.toFixed(2)+" "+s,opacity:t===y?"1":"0.18","stroke-linecap":"butt"}))}),n.appendChild(a),[.4,.8,1.2,1.6].forEach(y=>{let c=(180-y*90)*Math.PI/180,d=Z-oe/2-5,s=Z+oe/2+5,p=q+d*Math.cos(c),m=U-d*Math.sin(c),b=q+s*Math.cos(c),k=U-s*Math.sin(c);n.appendChild(B("line",{x1:p.toFixed(1),y1:m.toFixed(1),x2:b.toFixed(1),y2:k.toFixed(1),stroke:"#fff","stroke-width":"2.5"}))});let[r,i]=zr(e);n.appendChild(B("line",{x1:q,y1:U,x2:r.toFixed(2),y2:i.toFixed(2),stroke:t.color,"stroke-width":"3.5","stroke-linecap":"round"})),n.appendChild(B("circle",{cx:q,cy:U,r:"7",fill:t.color}));function u(y,c,d,s){let p=B("text",{x:y,y:c,"text-anchor":d,"font-size":"10",fill:"#bbb","font-family":"system-ui,sans-serif"});return p.textContent=s,p}return n.appendChild(u("14","132","start","Behind")),n.appendChild(u("246","132","end","Ahead")),n}function Hr(){C("trl-pace-styles",`
    .trl-pace-widget {
      font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
      background: #fff;
      border-radius: 16px;
